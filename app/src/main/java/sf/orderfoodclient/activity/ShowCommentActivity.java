...
import sf.orderfoodclient.helper.CommentViewHolder;
...
public class ShowCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // swipe layout
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipe_comment);
        ...
        // thread to load coment on first launch
